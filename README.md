...
View group members and identify the owner.

Leave any chat to remove it from your personal list.

Message Unsend: Users can delete their messages "for me" (local view) or "for everyone" (from the database).

Intuitive Chat Creation: A two-tab modal to easily find existing contacts or search for any user by their unique username.
